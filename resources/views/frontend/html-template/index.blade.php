  ...
  <body>
    ...
    <header id="home">
      ...
      <div class="container-fluid hero">
        ...
        <div class="container">
          <!-- Hero Title -->
          <h1>The Spirit of<br>Digital Learning.</h1>
          <!-- Hero Title Info -->
          <p>Learning is enough time to get the knowledge<br> Ans does not matter your age, So you can learn in any Age.</p>
          <div class="hero-btns">
            <!-- Hero Btn First -->
            <a data-scroll href="#about-us">More About</a>
            <!-- Hero Btn Second -->
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
              <div class="service-box">
                ...
                <p>Learn about graphics designing.</p>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
              <div class="service-box">
                ...
                <!-- Service Info -->
                <p>Learn about web development and App development</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container-fluid">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              <h2>See some of our<br>Creative works.</h2>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-12 col-lg-4 work-box">
              <div class="photobox photobox_type10">
                  <div class="photobox__previewbox">
                    ...
                    <!-- Replace Image Title Under -->
                    <span class="photobox__label">Career Helm related to our career to help each other.</span>
                  </div>
                </div>
            </div>
          </div>
            ...
            <div class="col-12 col-lg-4 work-box">
              <div class="photobox photobox_type10">
                  <div class="photobox__previewbox">
                    ...
                    <!-- Replace Image Title Under -->
                    <span class="photobox__label">Lusher web application to manage the multi vendor development for business purpose.</span>
                  </div>
                </div>
            </div>
            <div class="col-12 col-lg-4 work-box">
              <div class="photobox photobox_type10">
                  <div class="photobox__previewbox">
                    ...
                    <!-- Replace Image Title Under -->
                    <span class="photobox__label">Ecommerce Project to sell/buy mobile and accessories only vailable deferent type of variant over there.</span>
                  </div>
                </div>
            </div>
            <div class="col-12 col-lg-4 work-box">
              <div class="photobox photobox_type10">
                  <div class="photobox__previewbox">
                    <!-- Replace Patch to Image Under -->
                    <img src="{{ asset('html-css/images/portfolio/tiktok.png') }}" class="photobox__preview" alt="Preview">
                    <!-- Replace Image Title Under -->
                    <span class="photobox__label">Tiktok Boat web application for tiktok users.</span>
                  </div>
                </div>
            </div>
          </div>
